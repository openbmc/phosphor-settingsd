...
class Manager
{
    public:
        ...
        Manager(sdbusplus::bus::bus& bus)
        {
            settings =
                std::make_tuple(
                    std::make_unique<sdbusplus::xyz::openbmc_project::Control::Boot::server::Mode>(
                        bus,
            ...
            bus.emit_object_added("/xyz/openbmc_project/control/host0/boot_mode");

            std::get<1>(settings)->
                setPropertyByName("BootMode", Mode::Modes::Regular);
            bus.emit_object_added("/xyz/openbmc_project/control/host1/boot_mode");
    ...
    private:
        ...
        std::tuple<
            std::unique_ptr<sdbusplus::xyz::openbmc_project::Control::Boot::server::Mode>,
            std::unique_ptr<sdbusplus::xyz::openbmc_project::Control::Boot::server::Mode>> settings;
};
